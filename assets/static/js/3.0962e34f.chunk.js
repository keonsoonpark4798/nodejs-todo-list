    ...
    46: function (t, n, e) {
      ...
      var i,
        ...
        o = function (t) {
          ...
          return { name: t, value: n, delta: 0, entries: [], id: r(), isFinal: !1 };
        },
        u = function (t, n) {
          try {
        ...
        f = function () {
          addEventListener('pagehide', d), addEventListener('beforeunload', function () {});
        },
        p = function (t) {
          ...
          c || (f(), (c = !0)),
            addEventListener(
              ...
              function (n) {
                var e = n.timeStamp;
                'hidden' === document.visibilityState && t({ timeStamp: e, isUnloading: s });
              },
              { capture: !0, once: n },
            );
        },
        ...
        y = function (t) {
          var n,
            ...
            r = function (t) {
              var e = t.startTime;
              e < a.timeStamp ? ((i.value = e), i.entries.push(t)) : (i.isFinal = !0), n();
            },
